...
class CraftsControllerTest < ActionController::TestCase
  ...
  test "should create craft" do
    assert_difference('Craft.count') do
      post :create, craft: { auther: @craft.auther, description: @craft.description, image: @craft.image, name: @craft.name }
    end
  ...
  test "should update craft" do
    patch :update, id: @craft, craft: { auther: @craft.auther, description: @craft.description, image: @craft.image, name: @craft.name }
    assert_redirected_to craft_path(assigns(:craft))
  end
